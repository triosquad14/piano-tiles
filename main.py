# Piano Tiles
# Team members: Afreen Sultana.A, Priya dharshini, Muthu Abinaya
# Author : afreen
# team : trio squad
...
from object import Tile, Square, Text, Button, Counter
...
pygame.mixer.music.load('piano-bgmusic.mp3')
pygame.mixer.music.set_volume(0.8)
pygame.mixer.music.play(loops=-1)
# FONTS **********************************************************************

score_font = pygame.font.Font('Futura condensed.ttf', 32)
...
close_img = pygame.image.load('img_5.png')
replay_img = pygame.image.load('img_6.png')
sound_off_img = pygame.image.load("img_7.png")
sound_on_img = pygame.image.load("img_8.png")
...
with open('note.json.py') as file:
                ...
                if pos:
                    if tile.rect.collidepoint(pos):
                        if tile.alive:
                            ...
                            th = Thread(target='note.json.py', args=(f'{note}.ogg',))
                            th.start()
                            th.join()
